...
const MarketAnalysis = () => {
  ...
  // Also get multiple real-time data for price display
  const { getAllPrices } = useMultipleRealTimeData([selectedSymbol]);
      ...
      >
        ...
        <div>
          <PriceTicker
            ...
            data={{
              ...tickerData,
              price: currentPrices[selectedSymbol] || tickerData?.price || 0,
              // Ensure we have live price data
              isLive: isConnected && currentPrices[selectedSymbol] > 0
            }}
            size="lg"
            showVolume={true}
            className="h-full"
      ...
      >
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6">
          ...
          <div className="text-xs text-green-400 mt-2">
            Live Price: ${currentPrices[selectedSymbol]?.toFixed(2) || 'Loading...'}
          </div>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between mt-3 pt-2 border-t border-slate-600">
              ...
              <span className="text-primary font-medium">
                ${currentPrices[selectedSymbol]?.toFixed(2) || 'Loading...'}
              </span>
            </div>
          </div>
        </div>
